...
A Simple Fast API starter to learn python using cookiecutter
...
- Defaults are baked into src/server.py via APIServerConfig. You can also call
  APIServerConfig.from_yaml to load settings from a YAML file with environment
  interpolation.
